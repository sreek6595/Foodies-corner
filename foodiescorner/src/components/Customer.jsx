...
import { FaUtensils, FaConciergeBell, FaShoppingCart, FaMoneyBill, FaTruck } from "react-icons/fa";
...
const Customer = () => {
  ...
  const menuItems = [
    ...
    { label: "Add to Cart", icon: <FaShoppingCart />, route: "/addtocart" },
    { label: "View Cart", icon: <FaShoppingCart />, route: "/cart" },
    { label: "Order Now", icon: <FaMoneyBill />, route: "/order" },
    { label: "Order Tracking", icon: <FaTruck />, route: "/trackorder" },
    { label: "Payment", icon: <FaMoneyBill />, route: "/payment" },
  ];
  ...
  return (
    ...
    >
      ...
      <nav className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 shadow-md p-4 flex flex-col md:flex-row justify-between items-center text-white z-20">
        <h1 className="text-2xl font-bold ml-6">Foodies Corner - Customer</h1>
